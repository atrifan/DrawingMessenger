...
public class JSONDrawingsModel implements UserType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        DrawingsModel jsonObject = null;
        try {
            jsonObject = objectMapper.readValue(rs.getString(names[0]), DrawingsModel.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return jsonObject;

package ro.atrifan.client.google;
...
public class Google {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                Google.class.getClassLoader().getResourceAsStream("client_secret.json");
    ...
    public Google(String fileContent) {
        try {
            Drive service = getDriveService();
            File file = new File();
            file.setDescription("testing me 123");
            file.setMimeType("application/vnd.google-apps.drive-sdk");
            file.setName("something.json");
